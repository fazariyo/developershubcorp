...
const STATIC_ROUTES: { path: string; priority: number; changeFrequency: ChangeFrequency }[] = [
  ...
  { path: "/courses/ai-automation", priority: 0.8, changeFrequency: "monthly" },
  { path: "/courses/art-of-selling", priority: 0.8, changeFrequency: "monthly" },
  { path: "/courses/ai-content-generation", priority: 0.8, changeFrequency: "monthly" },
